...
export default function AnimalCategoryPage() {
  const vocabularies = [
    { name: "Fish", image: "/fish.png", stars: 3 },
    { name: "Cat", image: "/cat.png", stars: 2 },
    { name: "Lion", image: "/lion.png", stars: 1 },
    { name: "Bird", image: "/bird.png", stars: 0 },
    { name: "Butterfly", image: "/butterfly.png", stars: 3 },
    { name: "Spider", image: "/spider.png", stars: 3 },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="text-center py-6 bg-blue-300">
        <h1 className="text-3xl font-bold text-white">Animal</h1>
      </div>

      <div className="flex justify-center my-4">
        <a
          href="/menu/animal/doodle-game"
