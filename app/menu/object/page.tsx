...
export default function ObjectCategoryPage() {
  const vocabularies = [
    { name: "Bicycle", image: "/bicycle.png", stars: 3 },
    { name: "Car", image: "/car.png", stars: 2 },
    { name: "Clock", image: "/clock.png", stars: 1 },
    { name: "Flower", image: "/flower.png", stars: 0 },
    { name: "Tree", image: "/tree.png", stars: 3 },
  ];
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="text-center py-6 bg-blue-300">
        <h1 className="text-3xl font-bold text-white">Object</h1>
      </div>

      <div className="flex justify-center my-4">
        <a
          href="/menu/object/doodle-game"
